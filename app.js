...
var LOST_SYNONYMS={'羨慕':['羨慕','好想要他那樣'],'嫉妒':['嫉妒','吃醋','憑什麼他'],'生氣':['生氣','氣死','火大','不爽','怒'],'委屈':['委屈','受傷','不被理解','沒人看見'],'焦慮':['焦慮','緊張','不安','慌','睡不著','擔心'],'煩躁':['煩躁','煩死了','好煩','說不清楚哪裡煩'],'拖延':['拖延','懶得做','deadline','一直拖'],'空掉':['空掉','沒力氣','提不起勁','什麼都不想做'],'不甘心':['不甘心','我不服','這樣不公平','不甘'],'說不上來':['說不上來','說不清楚','怪怪的','就是不對']};
