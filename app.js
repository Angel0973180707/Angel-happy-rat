...
var LOST_MAP={
  '羨慕':{brain:'你看到別人抵達，\n大腦偷問：那我呢？',translate:'我也想要',need:['被看見','有成果','有選擇權'],action:'先寫下：我最羨慕的是哪一個部分？',rat:'酸一下沒關係。\n不要醃到自己。',tiger:'願望已經在敲門了。\n換你開吹。'},
  '嫉妒':{brain:'不是討厭他成功。\n是看到原來這條路有人走到了。',translate:'我不敢承認我想要',need:['被肯定','有選擇權','被看見'],action:'先寫下：我最羨慕的是哪一個部分？',rat:'酸可以。\n不要住進去。',tiger:'嫉妒是願望的雛形。\n先承認想要。'},
  '生氣':{brain:'有東西踩到你的底線。\n大腦拉了警報。',translate:'有東西踩到我的底線',need:['被尊重','有界線'],action:'先寫下：這次到底是哪一條線被踩了？',rat:'先去揍空氣。\n空氣比較耐打。',tiger:'界線清楚的人，\n才有資格畫大餅。'},
  '委屈':{brain:'不是小題大作。\n只是剛好戳到你很在意的地方。',translate:'我其實很在意',need:['被理解','被重視'],action:'先寫下：我希望對方知道的是什麼？',rat:'委屈不用忍。\n先讓小天鼠幫你翻譯成笑話。',tiger:'你還在意，\n代表還沒放棄期待。'},
  '焦慮':{brain:'大腦今天在拍災難片。\n劇本是它自己寫的。',translate:'我的大腦正在拼命保護我',need:['安全感','可預測性'],action:'先寫下：我最擔心的最壞結果是什麼？',rat:'焦慮不是弱。\n是大腦今天太認真上班。',tiger:'對細節敏感，\n往往也最謹慎。這是能力。'},
  '拖延':{brain:'不是懶。\n是任務在大腦裡看起來太大、太模糊。',translate:'我可能怕失敗，或任務太大',need:['安全感','小一點的第一步'],action:'先把任務切成一個5分鐘就能做完的小動作。',rat:'拖延的人通常很會想。\n只是屁股還沒動。',tiger:'先做最小的一步。\n氣勢會自己跟上來。'},
  '完美主義':{brain:'不是要求高。\n是怕被看見失敗的那一面。',translate:'我可能擔心做出來被否定',need:['安全感','被接納的失敗空間'],action:'先允許自己做一個「故意不完美」的版本。',rat:'完美主義是高標準\n穿著焦慮的外套。',tiger:'先吹個不完美的草稿。\n比完美的空想值錢。'},
  '想放棄':{brain:'電量真的低了。\n這不代表你不行，手機也需要充電。',translate:'我累了，不一定是我不行',need:['休息','支持'],action:'先休息一天，再決定要不要放棄。',rat:'累的時候做的決定，\n通常不是真的。',tiger:'休息完再回來。\n餅還在，沒人搶走。'}
};
var LOST_FALLBACK={brain:'你的大腦沒有在討厭你。\n它只是在用很笨的方式保護你。',translate:'我有一個還沒說出來的需求',need:['被理解','被看見'],action:'先寫下：這個感覺最像哪一種情緒？',rat:'說不清楚沒關係。\n小天鼠先陪你坐一下。',tiger:'迷航不是退步。\n是還在找方向而已。'};
