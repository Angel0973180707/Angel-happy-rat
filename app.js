...
var TARGET_ROAST_DB={
  ...
  other:{
    general:{
      truth:['生活，你最近很會喔。','「{input}」——還沒說清楚，煩度已先到現場了。','你說的我先接住。煩不用理由，但靶心要有名字。','說不清楚不代表沒有靶心。\n說說看，說出來比較好。'],
      analogy:['事情沒講清楚，煩度先開到最大聲。','待辦清單在旁邊裝不認識，它不理你，你先煩完再說。','問題還在排隊領號碼牌，情緒已先結帳出門了。'],
      honest:['我不怕麻煩。','事情不說清楚，嗆起來會傷到無辜的。','你先讓我知道是哪一件。不說出來，我只能全場掃射。','你先讓我知道是哪一件事。\n說出來，我才知道怎麼幫你。'],
      boundary:['我怕麻煩連名字都不報。','選一個：煩的是人、事，還是錢？報上來，剩下的先排號。','今天只找一個靶心，其他的先下班。','今天只找一個靶心。\n其他的先排隊。'],
