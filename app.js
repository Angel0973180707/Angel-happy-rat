...
var RAT_SESSION_PHRASES=[
  ['先不要氣。我先聽。','這題我熟。','等等，我想到一句。'],
  ['又來了？今天火氣很旺。','繼續說，我在聽。'],
  ['你今天很有素材。','第幾句了？','今天的料很足。'],
  ['你今天的嗆聲需求很旺盛。','我開始懷疑你是專業找碴師。'],
];
var TIGER_SESSION_PHRASES=[
  ['好。讓我吹。','這個夢可以放大。','吹牛不用繳稅金。'],
  ['又一個夢？好，繼續。','昨天一個，今天兩個。'],
  ['你今天的夢很旺。','你的野心還在增長中。'],
  ['繼續，我在估算宇宙容量。','你好像想建立一個帝國。'],
];
/* ── Loading 演戲：多行分行碎念腳本 ── */
  ...
  other:{
    ...
    situations:{
      comparison:{
        ...
        honest:[
          '你不敢說的是：你羨慕他，是因為他做了一件你也想做但還沒開始的事。',
          '你真正想說的是：「為什麼他可以，我不行？」——但你還沒認真問過自己這個問題。',
          '你沒說出口的是：你不是嫉妒他的成功，你是想念那個還沒放棄的自己。'
        ],
        boundary:[
          '別人的故事先放下，你自己的第一頁還空著。',
...
function roastDualActionRowHtml(){
  ...
  var regenLabel=roastResult.activeEngine==='spicy'?'🌶 再毒一點':'🐭 換一句';
  return '<div class="action-row">'
...
function bigDreamActionRowHtml(){
  ...
  var bdRegenLabel=bigDreamResult.activeEngine==='crazy'?'🚀 再吹高一點':'🔁 再吹一版';
  return '<div class="action-row">'
