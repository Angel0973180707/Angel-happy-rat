...
var TARGET_ROAST_DB={
  boss:{
    general:{
      truth:['你不是信任我。','你不是認為我行。','你不是要求高。','你不是在管理。'],
      analogy:['你是知道我說不出「不行」。','你是把我的時間當備用開關。','你是在把混亂外包給我。','你是在用「你最可靠」換我不說不。'],
      honest:['你再說「放心交給你」。\n我的行事曆就要申請保護令了。','你再不說謝謝。\n我的動力就要申請留職停薪了。','你再把我的名字從報告裡拿走。\n下次它就要自己回來了。','你再說「你最可靠」。\n可靠就要去談薪水了。'],
      boundary:['這件事我繼續做。\n但不是義務，是我的選擇。兩件事不一樣。','語氣是我今天唯一想要你改的東西。','做好了不說謝謝，我接受。\n但被當理所當然，我要說出來。','我繼續做。\n但不是理所當然，是我的選擇。']
    },
    situations:{
      overtime:{
        keywords:['加班','超時','下班','假日','休假','週末','留下','不能走','繼續做','沒辦法走'],
        truth:['你不是急。','你不是不知道幾點了。','你不是臨時才有。','你不是每次都這樣。'],
        analogy:['你是在用「緊急」換我的下班。','你是把今天的決策缺口裝進我的晚上。','你是在假裝緊急沒有截止時間。','你是把準備不足打包成我的緊急。'],
        honest:['你再把全部叫緊急。\n緊急就要去申請加薪了。','你再假裝下班線不存在。\n它就要自己畫出來了。','你再說「今晚就要」。\n我的今晚就要設密碼了。','你再送一個「再幫我一下」。\n一下就要出發票了。'],
        boundary:['今天可以留。\n但這是我的選擇，不是我的義務。','說「大家都要」之前，先問我。','緊急我理解。\n緊急不等於我沒有界線。','加班可以有。\n但不能是沒人知道的那種。'],
        comicExit:['我先不接天上掉下來的。\n你先說哪一件最不能等到明天。','我先不幫每一件都升等緊急。\n你先說今天真的不能等的那件。','我先不把全部都排進今天。\n你先說一件，今天最急的那個。']
      },
      blame:{
        keywords:['背鍋','責任','怪我','都是我','算我','我的問題','我的錯','甩鍋','推給我'],
        truth:['你不是剛好不知道。','你不是沒注意到。','你不是不確定。','你不是無辜的。'],
        analogy:['你是看到鍋就學會推出去。','你是剛好在責任出現時不在場。','你是確定了，但先讓別人的名字出現。','你是決策算你的，後果算我的。'],
        honest:['你再把鍋推出去。\n它就要自己滑回來了。','你再說「不是我的決定」。\n決策記錄就要去找你了。','你再假裝當時不知道。\n記憶就要自己出庭了。','你再讓別人扛你的決定。\n扛的人的名字就要出現在所有場合了。'],
        boundary:['我承擔我的那部分。\n但請先把它和不是我的部分分開。','說清楚誰決定了什麼，\n我才知道我要負責什麼。','我繼續做。\n但下次做決定的時候，我也要在房間裡。','說清楚誰決定再說誰負責。\n這個順序要先對。']
      }
    }
  },
  client:{
    general:{
      truth:['你不是在追求完美。','你不是有想法。','你不是給意見。','你不是給方向。'],
      analogy:['你是在用感覺代替決策。','你是把想清楚這件事外包給我了。','你是在給一個還沒想好的感覺。','你是在讓我幫你想你要什麼。'],
      honest:['你再說「感覺不太對」。\n感覺就要去上設計課了。','你再不確認方向。\n我的版本就要自己出版了。','你再說「就差一點點」。\n那一點點就要申請有薪假了。','你再改一輪。\n這份稿就要去辦身分證了。'],
      boundary:['方向先確認，再執行。\n你省時間，我省情緒。','你有權利不滿意。\n我也有權利說清楚這不在範圍內。','第三次修改之後，費用另外談。\n不是貪心，是我的時間有成本。','我的判斷也是報價的一部分。\n不是免費附贈的。']
    },
    situations:{
      revision:{
        keywords:['改','修改','再改','又改','改稿','不對','重做','重來','換','調整','版本','退稿','再調'],
        truth:['你不是追求完美。','你不是意見多。','你不是說不清楚。','你不是在給回饋。'],
        analogy:['你是在用改稿找你要什麼。','你是在把決策排進我的工時。','你是還沒想好就先讓我開始改了。','你是在找到答案之前一直用改稿當過場。'],
        honest:['你再改一次。\n這份稿就要去辦身分證了。','你再說「再調整一下」。\n版本紀錄就要去申請戶籍謄本了。','你再說感覺不對。\n我就要請感覺來開會了。','你再不圈一個確定的。\n這個案子就要自己去找下一位了。'],
        boundary:['三次修改以內算報價。\n之後重新計算，不是懲罰，是我的時間有成本。','下次先確認方向再動手。\n用文字說清楚要改什麼，讓我們都有憑據。','我繼續做。\n但我需要你告訴我你要什麼，不是你感覺哪裡不對。','四次以上要加收費用。\n不是懲罰，是這個工作有成本。']
      },
      rush:{
        keywords:['催','什麼時候','好了沒','進度','趕','急','快點','馬上','立刻','今天要','要趕','趕快'],
        truth:['你不是急。','你不是信任我能快。','你不是要求高。','你不是剛剛才決定。'],
        analogy:['你是把昨天的計畫空缺裝進我的今天。','你是把準備不足打包成我的緊急。','你是知道我趕完了會自己負責品質。','你是在用「相信你」換我的時間。'],
        honest:['你再說今天要。\n我的品質保證就要申請提前離場了。','你再把計畫不足叫緊急。\n緊急就要申請額外費用了。','你再不早說。\n下次的緊急就要預訂我的行事曆了。','你再說「簡單弄一下就好」。\n簡單就要去量它的工時了。'],
        boundary:['今天可以趕。\n但品質先說清楚，急件有急件的結果。','下次有急件，提前說我排；臨時說，我盡力，結果我們一起承擔。','急件加成先談，談完再開始。','急件要加成，做之前說清楚。\n說了才開始，這是規矩。']
      }
    }
  },
  coworker:{
    general:{
      truth:['你不是不知道誰要做。','你不是在合作。','你不是信任我。','你不是沒注意到。'],
      analogy:['你是在找最不會說不的那個。','你是在找人幫你接球。','你是知道我不會推回去。','你是注意到了，然後說「交給你」。'],
      honest:['你再說「交給你」。\n我的待辦清單就要出版了。','你再把球傳這邊。\n我就要申請傳球費了。','你再說「你比較熟」。\n熟就要開始計費了。','你再不記得輪到誰了。\n我就要幫大家印時刻表了。'],
      boundary:['這次我幫，下次輪到你。\n我說出來是因為想繼續合作，不是要吵架。','分享和包辦是兩件不同的事。\n這條線我要說清楚。','說清楚誰負責什麼。\n我們都比較好做事，也比較容易繼續當好同事。','我可以配合。\n但不可以一直在等對方想清楚再說。']
    },
    situations:{
      credit:{
        keywords:['功勞','表現','搶','我做的','沒說是我','沒提到我','說是他','佔便宜','沒認可','沒credit'],
        truth:['你不是健忘。','你不是剛好沒提。','你不是在分享成果。','你不是說錯了。'],
        analogy:['你是在換名字時讓我的消失了。','你是選擇性地記得說誰做的。','你是把「我們」說成只有你。','你是說的時候我的名字不見了。'],
        honest:['你再把我的成果換名字。\n它就要自己回來掛名了。','你再說「我負責的」。\n原版就要去申請著作權了。','你再在報告裡忘記提到我。\n記憶就要自己出席下次會議了。','你再說「我們做的」但成果算你的。\n「我們」就要去申請分拆了。'],
        boundary:['我說出來，是因為沉默讓我損失了什麼。\n我不想損失第二次。','下次合作前，先說好誰負責什麼、誰對外說話。','你可以用。\n但請讓我知道你在用，這是基本的尊重。','下次用我的東西之前，先告訴我。\n告訴我，就沒有問題。']
      },
      push_blame:{
        keywords:['推','卸責','不關我','都是你','你沒說','我不知道','沒人告訴','甩鍋','算你的'],
        truth:['你不是剛好不知道。','你不是路過。','你不是不確定。','你不是沒參與。'],
        analogy:['你是看到鍋就學會瞬移。','你是計算好什麼時候消失的。','你是確定了，但先推出去再說。','你是在找最近的人頂著。'],
        honest:['你再把鍋推出去。\n它就要滑回你桌上了。','你再說不關你。\n你的名字就要自己出現在記錄上了。','你再消失得那麼剛好。\n下次會議就要點你的名了。','你再說「我不知道」。\n知道的人就要主動出來了。'],
        boundary:['我可以幫解決。\n但我需要你承認我幫你解決了什麼。','下次出問題，先查源頭，再討論誰負責。','我繼續配合。\n但我不繼續扛不是我的那部分。','我幫你解決這次。\n但下次，我需要在源頭的那個討論裡。']
      }
    }
  },
  child:{
    general:{
      truth:['你不是沒聽到。','你不是不懂。','你不是忘了。','你不是不在意。'],
      analogy:['你是在算我說幾次才算數。','你是在看我的底線在哪裡。','你是在測試說好了有沒有效。','你是在等我放棄。'],
      honest:['你再試試底線在哪。\n底線就要搬家了。','你再讓我說第四遍。\n我的嗓子就要申請離職了。','你再假裝沒聽到。\n我的聲音就要出版錄音版了。','你再讓說好了沒有重量。\n說好就要開始收費了。'],
      boundary:['你可以不高興。\n但這件事還是要做，兩件事可以同時成立。','我愛你，但愛不等於沒有規定。\n規定是愛的另一種說法，今天繼續有效。','這件事我會繼續要求。\n不是要控制你，是因為我在乎你之後的樣子。','愛不等於沒有規定。\n今天的規定繼續有效。']
    },
    situations:{
      lateSleep:{
        keywords:['賴床','起床','叫不起','起不來','睡覺','睡太久','不肯起','鬧鐘','早上','起床氣','睡不醒'],
        truth:['你不是還沒醒。','你不是累。','你不是沒聽到鬧鐘。','你不是再一下下。'],
        analogy:['你是在跟棉被簽長約。','你是在假裝起床是可以棄權的。','你是希望鬧鐘先放棄。','你是在等我放棄叫你。'],
        honest:['你再跟床談戀愛。\n書包就要自己去上學了。','你再假裝沒聽到。\n鬧鐘就要換去別人房間住了。','你再讓棉被替你做決定。\n遲到單就要自己簽名了。','你再賴下去。\n早餐就要申請去跑外送了。'],
        boundary:['鬧鐘今天起交給你自己設，遲到的事情也由你自己說清楚——起床與準時是你要練習承擔的責任。','我愛你，但提醒有個節點，超過了之後的結果就是你的了。','明天你自己起，我來看你做得到嗎——這是一個練習，不是懲罰。','起床時間我叫過了。\n之後的事由你來承擔。']
      },
      homework:{
      ...
      procrastinate:{
        ...
        truth:['你說去做，他說等一下。','你不是在準備。','你不是很忙。','你不是快了。'],
        analogy:['那個「等一下」沒有截止時間。','你是在讓「開始」繼續排隊等你。','你是把明天當萬能替補員。','你是在等「等一下」什麼時候自己走。'],
        honest:['你再說等一下。\n等一下就要申請身分證了。','你再讓「現在」繼續等。\n等一下的等一下就要開分店了。','你再把明天當免費員工。\n明天就要申請勞基法保護了。','你再說快了。\n「快了」就要去量它到底幾公里外了。'],
        boundary:['事情今天完成，不是因為我催，是因為這是你的責任，責任不會因為等一下就消失。','我們可以一起想怎麼讓第一步變小一點，但第一步要今天踏出去。','你拖的代價由你自己承擔，我愛你，但我沒辦法替你承擔後果。','拖到最後的代價，\n今天由你自己承擔看看。']
      },
      picky:{
        keywords:['挑食','不吃','這個不要','那個不吃','只吃','不喜歡吃','挑嘴','不碰','噁心'],
        truth:['你不是沒辦法吃。','你不是真的不餓。','你不是今天心情不好。','你不是不喜歡。'],
        analogy:['你是今天不想給這道菜機會。','你是在看我什麼時候做你要的。','你是在測試不吃有什麼後果。','你是把「不要」當預設答案。'],
        honest:['你再說不吃。\n這道菜就要去別的桌找知音了。','你再讓廚師猜你要什麼。\n廚師就要申請心理輔導了。','你再說「上次喜歡這次不要」。\n上次就要來對質了。','你再一眼說不要。\n下次就讓它先不出現好了。'],
        boundary:['今天的飯就是今天的選擇，你可以不喜歡，但不可以不試——試一口是今天的規定。','我不會每次都做你喜歡的，但我願意聽你說什麼是你真的不行的，其他的我們都可以試試。','不吃可以，但餓了就是餓了，餓是今天選擇的結果——這個我先說清楚。','今天不吃，我尊重。\n肚子餓了，是你今天選擇的結果。']
      },
      talkBack:{
        /* 定義：孩子使用讓照顧者難以繼續溝通的語氣或方式回應。
           不同意、解釋、表達情緒本身不等於頂嘴。不把服從視為唯一正確答案。*/
        keywords:['頂嘴','回嘴','反嗆','大小聲','講不聽','沒禮貌','態度差'],
        truth:['你不是在溝通。','你不是在表達意見。','你不是在說你的想法。','你不是沒規矩。'],
        analogy:['你是在測試我能接幾句。','你是在用音效升級你的意見。','你是在把說話換成比大聲。','你是在看我什麼時候先閉嘴。'],
        honest:['你再升級音效。\n這個對話就要申請現場直播了。','你再加三句。\n我的回應就要申請提詞卡了。','你再說「就是就是」。\n我的底線就要重新劃線了。','你再不讓我說完。\n說話就要排號碼牌了。'],
        boundary:['你可以不同意，請換一個不傷人的方式說——等我們都能好好講，再繼續討論。','有意見可以說，說的時候讓我也說完，我們輪流，沒有人可以一直搶。','這個話題我想繼續，但需要我們都用平靜一點的語氣——現在先停一下，等一下再說。','現在先停。\n等兩個人都平靜了再繼續說。']
      },
      screen:{
        keywords:['手機','電視','平板','遊戲','3C','網路','影片','一直看','一直玩','不放下','YouTube','不關'],
        truth:['你不是沒聽見。','你不是在放鬆。','你不是快結束了。','你不是只是看看。'],
        analogy:['你是把耳朵租給手機了。','你是在假裝「再一下」有結束時間。','你是讓手機比我今天更得寵。','你是在讓螢幕替你做所有決定。'],
        honest:['你再讓手機當老大。\n作業就要申請離職了。','你再假裝快好了。\n「快好了」就要計時了。','你再讓耳機把我隔音。\n我就要去找音量更大的方式。','你再說再一下。\n那一下就要去申請計時器了。'],
        boundary:['時間到就是到，這是今天的規定，規定不是因為我不讓你快樂，是快樂要有節制才能持續。','我們可以一起訂一個你覺得公平的時間，但訂完了就要遵守——這個你要一起負責。','放下螢幕的決定由你做，後果也由你承擔——自律是練習，今天是其中一次。','時間到，放下。\n這是今天的規定，不是今天的心情。']
      },
      messyRoom:{
        keywords:['玩具','不收','亂丟','散','地上','不整理','亂','沒收','到處都是','收拾','不撿'],
        truth:['你不是還沒弄好。','你不是忘了。','你不是待會兒要收。','你不是不知道放哪裡。'],
        analogy:['你是在等我接手。','你是在看說了有沒有效果。','你是把「等一下」當收拾計畫。','你是在讓玩具自己決定住在哪裡。'],
        honest:['你再讓玩具自己選地址。\n它們就要申請常住戶籍了。','你再說等一下。\n等一下就要代收玩具了。','你再讓地板幫你保管東西。\n地板就要開始收倉儲費了。','你再讓我說第三遍。\n第三遍就要申請廣播頻道了。'],
        boundary:['收玩具是你的責任，不是我的事——我可以陪你收，但動手的是你。','說好了就做到，今天這件事是練習「說到做到」，這比玩具收不收更重要。','收完才可以繼續玩——這個順序不是懲罰，是今天的規則。','收完才繼續玩。\n這個順序今天不會改。']
      }
    }
  },
  parents:{
    general:{
      truth:['你不是不孝。','你不是不愛他們。','你不是不聽話。','你不是計較。'],
      analogy:['你是在找一個愛可以有邊界的方式。','你是愛他們，但今天這件事讓你很累。','你是希望換個方式說話，不是換人。','你是在找怎麼愛他們不讓自己透支。'],
      honest:['你再用擔心換我的決定。\n我的決定就要設密碼了。','你再說「我只是說說」。\n說說就要計字數了。','你再把「為你好」說出來。\n好的標準就要讓我來定義了。','你再問我幾點回家。\n我的行程就要申請保密了。'],
      boundary:['這個話題今天先暫停。\n不是不溝通，是我需要一點時間整理自己。','你們的關心我接受。\n但有些說話方式讓我受不了，這個我要說清楚。','我們可以不同意。\n請用溫和一點的方式說，因為我想繼續和你們說話。','我接受你們擔心。\n但有些說話方式我需要你們換一個。']
    },
    situations:{
      marriage:{
        keywords:['結婚','婚','男友','女友','交往','嫁','娶','催婚','對象','找個人','年紀','老了','來不及','沒對象'],
        truth:['你不是在關心。','你不是擔心我。','你不是在說你愛我。','你不是問我過得好不好。'],
        analogy:['你是把我的人生開成進度會議。','你是在替我設截止日期。','你是在查我的進度條往哪走。','你是在說：你到現在還沒到那裡。'],
        honest:['你再問一次進度。\n我的人生就要申請保密協定了。','你再催一次。\n婚姻就要申請躲避條款了。','你再說「別人都」。\n那個別人就要來吃飯了。','你再說「再不找來不及了」。\n我就要去問來不及的截止時間是幾點。'],
        boundary:['婚姻是我的事，你們的意見我會聽，但決定是我做的，時間也是我的——這兩件事請分開。','下次這個話題，請問我的感受，不是問我的進度——感受和進度是很不一樣的東西。','我們可以聊，但這個話題我需要你們用平靜的方式說，否則我沒辦法聽進去。','婚姻是我的事。\n時間也是我的。']
      },
      compare:{
        keywords:['比','別人','你看','人家','同學','表哥','表姊','鄰居','比不上','哪像你','別人家','別人的孩子','別人都'],
        truth:['你不是在鼓勵我。','你不是在舉例。','你不是在說別人好。','你不是不愛我。'],
        analogy:['你是在借別人的名字說我不夠。','你是在用別人的進度說我的不足。','你是不知道怎麼直說，借了別人的嘴。','你是每次說「別人」都是說我現在不夠好。'],
        honest:['你再說「你看別人」。\n那個別人就要來打招呼了。','你再拿別人的進度比我。\n我就要申請換個標準了。','你再說「同學都」。\n那個同學就要來吃飯了。','你再說「人家都做到了」。\n人家就要來和你說謝謝了。'],
        boundary:['你可以說你希望我怎樣，直接說，不要用別人來說——那個方式對我沒有用，只有傷害。','我在努力，只是你可能沒看見，因為我的努力不在你習慣看的地方——我希望你知道這件事。','下次開口之前，可以先說你看見了我什麼，然後再說你希望什麼——這個順序會讓我比較聽得進去。','說希望我怎樣，直接說。\n用別人說，我沒辦法聽進去。']
      },
      interfere:{
        keywords:['管','干涉','不關你','我的事','你不要管','一直問','一直說','煩死了','叫我','沒問你','管太多'],
        truth:['你不是不想被關心。','你不是不感謝。','你不是在逃避。','你不是不孝順。'],
        analogy:['你是覺得善意今天越過了那條線。','你是要自己做決定，不是拒絕被愛。','你是希望關心不等於替你決定。','你是想讓愛有邊界，不是讓愛消失。'],
        honest:['你再替我決定。\n我的選擇就要申請版權了。','你再問我一次進度。\n我的決策系統就要設密碼了。','你再說「我只是建議」。\n建議就要計次數了。','你再說「為你好」。\n好的定義就要讓我來。'],
        boundary:['這件事我自己來，結果好或壞都是我的，我需要你們給我這個空間——這是我成為大人的方式。','你們可以給意見，給完了讓我決定——意見和決定是不同人的事，這個邊界我需要說清楚。','我繼續聽你們說，但我希望說完你們也能聽我說——這是雙向的，不是只有一個方向。','這件事我來。\n好或壞，都是我的。']
      }
    }
  },
  sibling:{
    general:{
      truth:['你不是在計較。','你不是玻璃心。','你不是在記仇。','你不是小氣。'],
      analogy:['你是在最親近的關係裡，要求被對等對待。','你是因為在乎才說出來，不在乎的人沉默走了。','你是手足說的話傷最深，因為你最在乎他的看法。','你是愛這個手足，但今天這份愛沒有被對等對待。'],
      honest:['你再說「不是這個意思」。\n那個意思就要申請字幕了。','你再假裝說完沒事。\n下次我的話就要先保留了。','你再說我太敏感。\n敏感就要去量你說話的重量了。','你再讓這件事掛著。\n它就要自己去找調解員了。'],
      boundary:['我說出來，不是要吵架。\n是要這件事不要一直掛在我們中間。','不同意可以，請用說的方式解決，不要用不講話。\n我想繼續好好說話。','這次說清楚，不是要贏。\n是要讓我們之後好過一點。','這件事今天說清楚。\n說完，我們繼續。']
    },
    situations:{
      care:{
        keywords:['照顧','父母','爸媽','老人','長輩','回家','負責','都是我','沒人幫','一個人','你不回','你不管','不出力','不分擔','看護'],
        truth:['你不是計較誰做多少。','你不是要人感謝你。','你不是要公平分配。','你不是在抱怨。'],
        analogy:['你是一個人扛著，他假裝沒看見。','你是接力賽，目前只有你在跑。','你是一直在發訊號，但對方不在接收端。','你是把所有球都接住了，想知道其他人在哪。'],
        honest:['你再讓他假裝沒看見。\n你接的球就要申請立牌了。','你再一個人撐下去。\n「一個人」就要去找支援了。','你再不說出來。\n他就要繼續以為現在這樣就好了。','你再什麼都自己扛。\n扛的清單就要去出版了。'],
        boundary:['這件事我們需要坐下來分工，不是現在這樣各說各的——這個對話我需要我們一起做。','我繼續做，但我需要你承認你知道我做了什麼，然後我們討論下一步——這兩件事都很重要。','我不是要你有罪惡感，我是要你真正進來這個責任裡一起承擔，方式可以討論。','我繼續做。\n但下次需要你進來，一起承擔。']
      },
      money:{
        keywords:['錢','借','還','欠','分擔','費用','花費','沒還','說好','出錢','不出','計較錢','不還'],
        truth:['你說的是錢。','你不是小氣。','你不是計較數字。','你不是要鬧翻。'],
        analogy:['但他聽到的，是另一件事。','你是希望那個不對等有人說清楚。','你是說錢，說的是這件事有沒有被認真對待。','你是想讓錢說清楚了，感情才能繼續。'],
        honest:['你再讓這件事掛著。\n它就要在你們中間設攤位了。','你再假裝這不重要。\n重要的事就要自己報名了。','你再讓借出去的東西不了了之。\n它就要自己寫催繳單了。','你再不說出來。\n這件事就要繼續影響你對他的感覺了。'],
        boundary:['我們說清楚，說完就繼續，不要讓錢的事一直掛在我們中間——這是我說出來的原因。','下次有需要，早點說，說清楚再做，對你對我都比較好——這不是規定，是習慣。','我願意幫，但幫的前提是我們雙方都清楚這不是理所當然，是我選擇的。','下次有需要，先說。\n說完再動，對大家都好。']
      }
    }
  },
  partner:{
    general:{
      truth:['你們不是在吵架。','你不是無理取鬧。','你不是要贏。','你不是不愛他。'],
      analogy:['你們是在用很破的方式說你在乎。','你是在乎，所以才這麼費力。','你是要他知道你還在這裡，還很在乎。','你是愛他才費力，不在乎的人早就走了。'],
      honest:['你再讓這次沒說清楚。\n下次就要再說一次了。','你再不說你真正要的是什麼。\n他就要繼續猜了。','你再說「算了」。\n沒說出來的就要繼續住在你這裡了。','你再讓今天就這樣過去。\n今天就要明天再來一次了。'],
      boundary:['我不是要你道歉。\n我是要你真的完整聽我說一次。','「以後改」這句話，我需要它有個方向。\n不用很快，但我要看見你有在想。','我還在這裡，因為我還在乎。\n但我需要你也讓我感覺你在這裡。','我還在，因為我還在乎。\n但我需要你讓我感覺你也在。'],
      comicExit:['我先不跟手機比紀錄。\n你先翻面放著，說一句話。','我先不計算誰說了幾次。\n你先說一件最想讓我知道的。','我先不比今晚的陪伴時數。\n你先讓我說完一件事。']
    },
    situations:{
      misunderstand:{
        keywords:['不懂','不在乎','不理解','不關心','你都不','你從來','你沒有','不把我','你不明白','你不知道','沒有感覺'],
        truth:['你不是要求他完美。','你不是玻璃心。','你不是想贏。','你不是要他道歉。'],
        analogy:['你是要被看見，不是要他做更多。','你是感覺到他不在乎，他說有，但你看不見。','你是在問：你對他重不重要。','你是要他完整聽你說一次，不是要道歉。'],
        honest:['你再說「算了，你不懂」。\n不懂就要繼續不懂了。','你再不說你要的是什麼。\n他就要繼續猜你要什麼了。','你再讓「我有在聽」停在那裡。\n「在聽」就要附上回應了。','你再讓他說「我知道了」就結束。\n知道就要讓你看見了。'],
        boundary:['下次我說什麼，我需要你說回來讓我知道你聽進去了——不是測試，是確認。','我繼續說，你繼續試著聽——這件事我們兩個人都要做，缺一個都不夠。','你不用做到完美，但讓我看見你有在努力，對我來說那就夠了。','說完讓我知道你聽到了什麼。\n不是測試，是確認。']
      },
      household:{
        keywords:['家務','家事','掃','拖','碗','洗碗','洗衣','煮飯','整理','收拾','不做','都是我','你沒做','沒分擔'],
        truth:['你不是在計較家務。','你不是要他做一樣多。','你不是要追究。','你不是要分工表。'],
        analogy:['你是在說：這個家是兩個人的。','你是累的不只是做了什麼，是沒人主動說「我來」。','你是希望他不用你說就知道有事要做。','你是要他讓你感覺這是兩個人的家。'],
        honest:['你再讓家務只有你看見。\n它就要申請掛名了。','你再讓「我忘了」繼續有效。\n忘了就要去設提醒了。','你再不說你累了。\n累就要繼續在這裡等你說。','你再等他自己想到。\n等就要開始計算幾天了。'],
        boundary:['我們列一下誰負責什麼，不是要計算，是要兩個人都知道這個家的事——列完了大家都輕鬆。','你不用做到一半，但讓我感覺你有在負責，這對我很重要——你做什麼不重要，你有意識到很重要。','我繼續做，但我需要你主動看見有什麼可以做——不用等我說，這件事比分擔的比例更重要。','我繼續做。\n但我需要你讓我感覺這是我們兩個人的家。']
      }
    }
  },
  friend:{
    general:{
      truth:['你不是計較。','你不是太需要。','你不是玻璃心。','你不是記仇。'],
      analogy:['你是以為友誼是對等的。','你是在乎這個人，才讓他讓你生氣。','你是期待被打折了，打折的是這個人。','你是還在乎，才說出來，不在乎的人沉默走了。'],
        honest:['你再讓這件事沒說出來。\n它就要繼續住在你和他之間了。','你再說「沒關係」。\n有關係的事就要自己報到了。','你再一個人覺得不對等。\n不對等就要請他也感覺一下了。','你再假裝沒事。\n沒事就要繼續是一件事了。'],
      boundary:['我說出來，不是要你道歉，是要這件事不要一直掛在我們中間——說清楚了我們繼續。','說完了我想繼續這段友誼，所以我才說，我希望你知道這是我說的原因。','你說你不知道，好，現在你知道了，我希望這個「知道了」有一點重量。','說完了我想繼續好。\n這是我說出來的原因。']
    },
    situations:{
      cancel:{
        keywords:['爽約','放鳥','取消','臨時','說好','不來','不去','突然','改期','忘了','沒出現','沒來'],
        truth:['你調整了時間去等。','你不是不能理解。','你不是真的氣那個約。','你不是在計較。'],
        analogy:['他說不來了，就這樣。','你是不知道你的時間在他那裡算什麼。','你準備好了，他那邊根本沒準備。','你準備好的心情沒地方放。'],
        honest:['你再說「沒關係改期」。\n改期就要開始收訂金了。','你再讓臨時不來有效。\n有效就要去申請上限了。','你再說「我理解」。\n你的等就要申請紀念牌了。','你再讓他的原因蓋過你的感覺。\n感覺就要自己出來說話了。'],
        boundary:['有事說一聲，早一點說，讓我有時間改計畫——這是我需要的，不是什麼大要求。','下次不確定能來就先說不確定，比說好了又取消要讓我好過很多。','我還是想和你約，但我需要你對我們的約認真一點——不是要你完美，是要你記得我在等。','下次說好了，就是好了。\n不確定，就先說不確定。']
      },
      gossip:{
        keywords:['說出去','說了','洩露','秘密','到處說','跟別人說','我說的','不可以說','背刺','傳出去','亂說','散布'],
        truth:['你說的話，原來不是安全的。','你不是故意的。','你不是要傷害我。','你不是壞人。'],
        analogy:['但你把我的話外借出去了。','你是說出去之後，我的話就不只是我的了。','你是不知道說了有多大，但結果在那裡。','信任是借給你的，你把它再借出去了。'],
        honest:['你再說出去一件。\n我的話就要附保密條款了。','你再說「我只是說說」。\n說說就要計算傳播範圍了。','你再假裝說出去沒事。\n沒事就要去找當事人了。','你再讓信任當空氣流通。\n空氣就要設關卡了。'],
        boundary:['下次我說什麼，不確定可不可以說，先問我——問完你再決定，這是我需要的。','我說的是我的，不是你的，這個所有權的問題我需要你清楚，說了就是說了。','我還是想和你做朋友，但我需要知道我說的東西在你這裡是安全的——這個對我很重要。','下次我說的事，\n請先問我可不可以說，再說。']
      }
    }
  },
  other:{
    general:{
      truth:['你不是不知道煩什麼。','「{input}」——還沒說清楚，不爽已先到了。','你不是沒事。','說不清楚先說出來。\n悶著沒有出路。'],
      analogy:['你是讓煩在腦內無照營業。','你是讓所有事混在一起比大聲。','問題還在排隊領號碼牌，情緒已先結帳出門了。'],
      honest:['你再假裝沒事。\n它就自己開記者會了。','你再讓煩沒有名字。\n叫不到名字，就送不走。','你再讓所有事混在一起。\n它們就要開分店了。','你再說「最近很煩」。\n煩就要申請身分證了。'],
      boundary:['我怕麻煩連名字都不報。','選一個：是人、是事，還是自己？說清楚那一件，其他先等。','今天只找一件說清楚，其他的先下班。','今天只找一件。\n其他的先排隊。'],
      comicExit:['我先不替它宣傳。\n你先說哪一件煩最大聲。','我先不幫所有事情排名。\n你先說最煩的那一件叫什麼。','我先不幫它找出路。\n你先說最讓你卡住的那件叫什麼。']
    },
    situations:{
      comparison:{
        ...
        comicExit:['我先不叫你別看別人。\n你先說一件你自己想要的，具體一點。','我先不替別人的故事評分。\n你先說你自己的第一行是什麼。','我先不管別人的進度。\n你先說你自己想去哪裡。']
      }
    }
  }
};
...
function _v2Section(title,lines){
  var content=lines.filter(Boolean).map(function(l){return l.split('\n').map(escapeHtml).join('<br>');}).join('<br>');
  if(!content) return '';
