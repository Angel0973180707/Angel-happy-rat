...
var TARGET_ROAST_DB={
  boss:{
    ...
    situations:{
      ...
      blame:{
        ...
        truth:['你沒有犯的錯，要當結案理由。\n這是分配委屈，不是解決問題。','你被要求負責的事，原本不在你的決策範圍內。','你的名字不知道什麼時候變成「出問題就填這裡」。','你被要求負責的範圍，\n比你被告知要負責的大。'],
        analogy:['你就像被貼上「萬用標籤」的人。\n找不到負責人，先看你身上有沒有空格。','責任的分配像停車格。\n先到先停，但先到的標準不太固定。','你的名字變成了預設答案。\n沒人說什麼時候開始的。'],
        honest:['你知道不是你的錯。\n說出來的代價你怕了，所以先扛著。','你想說：下次出問題，先查一下是誰的決定。','每次被推到前面，都少了一點繼續努力的動力。','你想說：決定的時候讓我也在場。\n我早點知道，早點說得出問題在哪。'],
  ...
  client:{
    general:{
      ...
      honest:['你說隨便發揮，我發揮了。\n你說不對。\n這個邏輯我研究不透。','你願意改。\n但希望改的是真的意見，不是「感覺不對」。','做完之後，你不確定還剩多少是你想做的東西。','你可以繼續合作。\n但下次說隨便，就是真的隨便。'],
    ...
    situations:{
      revision:{
        ...
        honest:['你不確定現在這個版本有沒有更好。\n只知道它一直在改。','如果你一開始說清楚，我可以做得更好。\n你說的是感覺。','每一次「小改一下」，對你來說都是重新來過。','你可以繼續改。\n但每次改之前，需要你用文字說清楚要改什麼。'],
  ...
  child:{
    ...
    situations:{
      ...
      procrastinate:{
        ...
        truth:['你不是在生拖延的氣，你是在對抗「說了等一下就真的等到下一次」的那個循環。','你看見的是孩子在拖，你在意的是這件事是否還會被做到，還是就這樣消失了。','拖延背後有時候是不知道怎麼開始，但你現在最需要的是把事情往前推一步。','你不是在逼他快。\n你是在問：你說的話他有沒有放在心上。'],
      ...
      picky:{
        ...
        truth:['你不是在計較吃什麼，你是在說：我用心準備的東西，我希望被好好對待。','你在意的不只是那道菜，是「我做了這件事，但對方好像不需要」的那個感覺。','孩子挑食讓你很累，是因為你不是只在處理吃飯，你在處理「我的付出夠不夠被看見」這個問題。','你不只在解決吃飯。\n你在教他「先試試看」是什麼意思。'],
      ...
      screen:{
        ...
        truth:['你看見的是孩子黏著螢幕，你真正擔心的是那個螢幕把他和其他事情之間的距離拉遠了。','你不是反對快樂，你是擔心這個快樂把其他的事情都擠掉了，而且他不知道。','螢幕讓孩子高興，你也看見了，但你同時看見了其他還沒做的事，這兩件事讓你很矛盾。','你不是要拿走他的快樂。\n你是在說：快樂要有邊界才能持續。'],
      ...
      messyRoom:{
        ...
        truth:['你不是在計較那些玩具，你是在說：你說了要收，但什麼都沒有發生，你說的話好像沒有重量。','你在意的不是整齊，是「我提醒了，但對方當作沒聽到」的那個感覺。','你要的不是完美的房間，你要的是你說的話有人在聽。','你希望他學到的不是整齊。\n你希望他學到「說了要做到」。'],
  ...
  parents:{
    ...
    situations:{
      marriage:{
        ...
        truth:['你不是不想結婚，你是不想用別人的時間表來決定自己的人生——這兩件事很不一樣。','他們催婚是因為他們擔心，但他們的擔心不代表他們的答案對你是對的。','你在被要求解釋一件你還沒有決定要如何的事，這比婚姻本身還累。','婚姻不是用進度條算的事。\n但他們只看得見進度條。'],
      ...
      interfere:{
        ...
        truth:['你不是不想被關心，你是覺得關心和管制之間的那條線，今天被越過了。','他們管你，是因為他們對你的恐懼還沒有消失，但這不是你應該一直接住的東西。','你想要自己做決定，他們想要確認你安全——這兩件事都是真的，但它們今天撞上了。','他們不是壞意。\n但善意不等於有權決定。'],
  ...
  sibling:{
    ...
    situations:{
      ...
      money:{
        ...
        truth:['錢的問題背後通常不是錢的問題，是「我們之間的付出有沒有被對等對待」的問題。','你不是吝嗇，你是覺得這個關係裡的付出不對等，而且那個不對等沒有被正視。','你說錢，他聽到的可能是另一件事；他說「沒有」，你聽到的可能也是另一件事。','錢說清楚了，感情才能繼續。\n不說清楚，後面什麼都模糊。'],
  ...
  partner:{
    ...
    situations:{
      misunderstand:{
        ...
        truth:['你不是要求他完美，你是希望被看見，這個希望很正當，不需要解釋為什麼。','你感覺到的「不在乎」，可能不是真的不在乎，只是他表達在乎的方式你不容易看見。','你不是想贏，你是想知道你在他心裡是不是重要的——這和爭對錯是很不一樣的事情。','你不是要他道歉。\n你要的是他完整聽你說一次。'],
      ...
      household:{
        ...
        truth:['你不是在計較家務，你是在說：這個家是兩個人的，但扛的比例讓你覺得不對等。','你累的不只是那些事情本身，是那些事情背後從來沒有人主動說「我來」的感覺。','你希望他把家事當成他自己的事，不是你的事——這個區別很大，但很難說清楚。','你希望他主動看見有什麼可以做。\n不用你說，他就知道。這個期待很正當。'],
  ...
  friend:{
    general:{
      truth:['你說的是「{input}」——朋友讓你生氣，是因為你在乎這段關係，不在乎的人讓你難過，在乎的人讓你生氣。','關於「{input}」，你不是在計較，你是在說：我以為這段友誼對你和我一樣重要。','你生氣，是因為你的期待被打了折扣，而那個折扣你沒想到會來自這個人。','你在乎這段友誼，\n所以才說。不在乎的人沉默就走了。'],
    ...
    situations:{
      cancel:{
        ...
        truth:['你不是在計較一個約，你是在說：我為了這件事調整了我的時間，但你不在乎。','他放你鳥，可能有他的原因，但原因不代表你不能有感覺——這兩件事都是真的。','你生氣的不是那個約本身，是那個約背後你準備好了但對方沒準備好的落差。','你準備好的心情沒地方放。\n這個感覺比那個約本身更難處理。'],
      ...
      gossip:{
        ...
        truth:['你說了不該說的，讓我懷疑我在這段關係裡的安全感，這不是小事。','你把我的事說出去，可能不是故意的，但後果是真的，我的感受也是真的——兩件事都要說。','你讓我學到了一件事，但這是我不想學的那種事：什麼在你這裡是安全的，什麼不是。','你告訴他是因為你信任他。\n信任是借給他的，他用掉了。'],
  ...
  other:{
    general:{
      truth:['生活，你最近很會喔。','「{input}」——還沒說清楚，但那股不爽已先到了。','你說的我先接住。煩不用理由，但說清楚哪一件才算數。','說不清楚沒關係。\n說說看，說出來比較好。'],
      analogy:['事情沒說清楚，那股不爽先大聲了。','待辦清單在旁邊裝不認識，它不理你，你先煩完再說。','問題還在排隊領號碼牌，情緒已先結帳出門了。'],
      honest:['我不怕麻煩。','事情不說清楚，嗆起來會傷到無辜的。','你先讓我知道是哪一件。不說出來，嗆錯方向都有可能。','你先讓我知道是哪一件事。\n說出來，我才知道怎麼幫你。'],
