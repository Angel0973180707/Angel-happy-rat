...
const CONTENT_DB = {
      ...
      chef: {
        ...
        tiger: {
          l1: [
            '說出「我卡在哪一題」，米其林評審台就位了。',
            '說出「我先做這科」，主廚已在廚房候場。',
            '打開作業本那個動作，等於點燃了第一根爐火。',
          ],
          l2: [
            '失蹤主廚復出消息傳開，稽查員說：我等你出菜。',
            '料理界宣布：失蹤主廚今晚回來了。',
            '第一道菜出，評審從便條本翻到最後一頁。',
          ],
          landing: [
            '但米其林先不急。現在：選一科，或說卡在哪一題。',
            '但稽查員先不急。現在：選一科，或說卡在哪。',
            '但評審先不急。現在：打開作業本，翻到作業那頁。',
          ],
        },
      },
    },
  ...
  'conflict_boss_overload': {
    ...
    worlds: {
      weather: {
        ...
        tiger: {
          l1: [
            '你說「撐不住了」，氣象史最珍貴的觀測記錄誕生了。',
            '你的待辦清單已達颱風等級，多路登陸，同時進行。',
            '全部叫緊急，等於同時登陸，氣象局已棄守。',
          ],
          l2: [
            '世界待辦氣候峰會緊急開幕，主題：人類能扛幾個緊急？',
            '各大新聞台就位，只等你說出今天最急的那一件。',
            '委員會投票結論：降一件，否則今天預計崩盤。',
          ],
          landing: [
            '峰會先不開。現在：今天唯一最急的那件，說出來，只一件。',
            '記者會先不開。現在：最急的那件叫什麼，說出來。',
            '委員會先不投票。現在：移出一件，或把它降順位。',
          ],
        },
      },
    },
  ...
  'general_other': {
    ...
    worlds: {
      life: {
        ...
        tiger: {
          l1: [
            '「最近很卡」四個字一出，生活客服中心亮紅燈。',
            '你這句話一送出，全宇宙待辦清單緊急集合，爭先恐後搶上議程。',
            '這四個字訊號強度，已觸發生活方程式緊急重算，顧問委員會連夜趕稿。',
          ],
          l2: [
            '待辦清單在旁邊裝不認識。',
            '各事項代表爭相發言：「不是我，是另一件。」現場一片推諉，井然有序。',
            '分析報告出爐，結論是：「根源為多選題，請先圈一個。」委員會鼓掌通過。',
          ],
          landing: [
            '先不開全宇宙記者會。現在：選一個，卡的是人、事，還是錢？',
            '委員會先不投票。現在：最讓你卡住的那一件，名字是什麼？',
            '記者會暫停直播。現在：說最卡的那件，其他先排號。',
          ],
        },
      },
    },
  ...
  'specific_partner_screen': {
    ...
    worlds: {
      phone: {
        ...
        tiger: {
          l1: [
            '唬爛虎現場觀察：旁邊有人在等，螢幕工時已超標。',
            '你的眼神在螢幕上，旁邊那個存在，還沒被看見。',
            '螢幕剛加了一個工時，旁邊那個人還在等。',
          ],
          l2: [
            '手機說它不知道旁邊有人在等，手機說謊了。',
  ...
  // ══ specific: 客戶 × 改稿  comicWorld: revision（改稿現場）══════════
  'specific_client_revision': {
    availableWorlds: ['revision'],
    truth: [
      '你再讓「感覺不對」繼續導航。',
      '你再讓「再調整一下」沒有終點站。',
      '你再讓這份稿繼續等「就差一點點」說清楚。',
    ...
    worlds: {
      revision: {
        ...
        tiger: {
          l1: [
            '唬爛虎觀察記錄：「感覺不對」是沒有地址的需求，地址現在要填了。',
            '唬爛虎偷看到改稿清單了——它在排隊自我介紹給下一個設計師。',
          ],
          l2: [
            '改稿第四版的時候，規格書已經自己出門找說明了。',
            '委員會決定：這次修改要先說出一個確定想要的。',
          ],
          landing: [
            '先不改稿。現在：說一個你確定想保留的，只要一個。',
            '感覺先放旁邊。現在：說一個你確定不要的字。',
          ],
        },
      },
    },
